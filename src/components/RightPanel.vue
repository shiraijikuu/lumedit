  ...
  <aside class="right-panel">
    ...
    <div class="social-bar">
      ...
      <div class="social-links">
        <button class="social-btn" type="button" :title="t('about.douyin')" :aria-label="t('about.douyin')" @click="openLink(SOCIAL.douyin)">
        ...
        <button class="social-btn" type="button" :title="t('about.bilibili')" :aria-label="t('about.bilibili')" @click="openLink(SOCIAL.bilibili)">
